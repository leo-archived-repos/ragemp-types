declare module 'rage-client' {
	...
	export namespace WeaponComponents {
		export const enum Knuckle_Duster {
			/** Base Model */
		...
		export const enum Combat_Pistol {
			/** Default Clip */
		...
		export const enum Heavy_Revolver {
			/** VIP Variant */
		...
		export const enum Heavy_Pistol {
			/** Default Clip */
		...
		export const enum Heavy_Revolver_Mk_II {
			/** Default Rounds */
		...
		export const enum SNS_Pistol_Mk_II {
			/** Default Clip */
		...
		export const enum Pistol_Mk_II {
			/** Default Clip */
		...
		export const enum Vintage_Pistol {
			/** Default Clip */
		...
		export const enum Up_n_Atomizer {
			/** Festive tint */
			COMPONENT_RAYPISTOL_VARMOD_XMAS18 = 0xd7dbf707
		}

		export const enum Ceramic_Pistol {
			/** Default Clip */
		...
		export const enum Machine_Pistol {
			/** Default Clip */
		...
		export const enum Pump_Shotgun {
			/** Flashlight */
			COMPONENT_AT_AR_FLSH = 0x7bc4cddc,
			/** Suppressor */
		...
		export const enum Sawed_Off_Shotgun {
			/** Gilded Gun Metal Finish */
			COMPONENT_SAWNOFFSHOTGUN_VARMOD_LUXE = 0x85a64df9
		}

		export const enum Assault_Shotgun {
			/** Default Clip */
		...
		export const enum Bullpup_Shotgun {
			/** Flashlight */
			COMPONENT_AT_AR_FLSH = 0x7bc4cddc,
			/** Suppressor */
			COMPONENT_AT_AR_SUPP_02 = 0xa73d4664,
		...
		export const enum Pump_Shotgun_Mk_II {
			/** Default Shells */
		...
		export const enum Heavy_Shotgun {
			/** Default Clip */
		...
		export const enum Combat_Shotgun {
			/** Flashlight */
			COMPONENT_AT_AR_FLSH = 0x7bc4cddc,
			/** Suppressor */
			COMPONENT_AT_AR_SUPP = 0x837445aa
		...
		export const enum Assault_Rifle {
			/** Default Clip */
		...
		export const enum Carbine_Rifle {
			/** Default Clip */
		...
		export const enum Advanced_Rifle {
			/** Default Clip */
		...
		export const enum Special_Carbine {
			/** Default Clip */
		...
		export const enum Bullpup_Rifle {
			/** Default Clip */
		...
		export const enum Bullpup_Rifle_Mk_II {
			/** Default Clip */
		...
		export const enum Special_Carbine_Mk_II {
			/** Default Clip */
		...
		export const enum Assault_Rifle_Mk_II {
			/** Default Clip */
		...
		export const enum Carbine_Rifle_Mk_II {
			/** Default Clip */
		...
		export const enum Compact_Rifle {
			/** Default Clip */
		...
		export const enum Military_Rifle {
			/** Default Clip */
		...
		export const enum Combat_MG_Mk_II {
			/** Default Clip */
		...
		export const enum Gusenberg_Sweeper {
			/** Default Clip */
		...
		export const enum Sniper_Rifle {
			/** Default Clip */
		...
		export const enum Heavy_Sniper {
			/** Default Clip */
		...
		export const enum Marksman_Rifle_Mk_II {
			/** Default Clip */
		...
		export const enum Heavy_Sniper_Mk_II {
			/** Default Clip */
		...
		export const enum Marksman_Rifle {
			/** Default Clip */
		...
		export const enum Grenade_Launcher {
			/** Default Clip */
