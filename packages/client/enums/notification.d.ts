declare module 'rage-client' {
	 ...
	 *
	 * [https://wiki.rage.mp/index.php?title=Notification_Pictures](https://wiki.rage.mp/index.php?title=Notification_Pictures)
	 */
	export const enum NotificationsPictures {
		/**
